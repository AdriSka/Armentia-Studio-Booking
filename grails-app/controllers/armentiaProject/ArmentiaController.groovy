...
class ArmentiaController {
    ...
    def save(Armentia armentiaInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'armentia.label', default: 'Armentia'), armentiaInstance.id])
    ...
    def update(Armentia armentiaInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'Armentia.label', default: 'Armentia'), armentiaInstance.id])
                redirect armentiaInstance
            }
    ...
    def delete(Armentia armentiaInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'Armentia.label', default: 'Armentia'), armentiaInstance.id])
