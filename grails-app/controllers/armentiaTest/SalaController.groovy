...
class SalaController {
    ...
    def save(Sala salaInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.created.message', args: [message(code: 'sala.label', default: 'Sala'), salaInstance.nombreSala])
    ...
    def update(Sala salaInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'Sala.label', default: 'Sala'), salaInstance.nombreSala])
                redirect salaInstance
            }
    ...
    def delete(Sala salaInstance) {
        ...
        request.withFormat {
            form multipartForm {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'Sala.label', default: 'Sala'), salaInstance.nombreSala])
