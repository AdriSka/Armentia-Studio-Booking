...
<html>
	...
	<body>
		<a href="#create-sala" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-sala" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:salaInstance, action:'save']" >
				<fieldset class="form">
