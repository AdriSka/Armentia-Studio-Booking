...
class BandaController {
	...
	def save(Banda bandaInstance) {
		...
		request.withFormat {
			form multipartForm {
				flash.message = message(code: 'default.created.message', args: [message(code: 'banda.label', default: 'Banda'), bandaInstance.nombre])
	...
	def update(Banda bandaInstance) {
		...
		request.withFormat {
			form multipartForm {
				flash.message = message(code: 'default.updated.message', args: [message(code: 'Banda.label', default: 'Banda'), bandaInstance.nombre])
				redirect bandaInstance
			}
	...
	def delete(Banda bandaInstance) {
		...
		request.withFormat {
			form multipartForm {
				flash.message = message(code: 'default.deleted.message', args: [message(code: 'Banda.label', default: 'Banda'), bandaInstance.nombre])
